...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private LinkedList<String> possibleEdges = new LinkedList<>();
    boolean possibleValidHighway = false;
    String currentId;
...
//            System.out.println("Node lat: " + attributes.getValue("lat"));
            ...
            g.edges.put(Long.parseLong(currentId), new LinkedList<>());
...
//            System.out.println("Id of a node in this way: " + attributes.getValue("ref"));
            ...
            possibleEdges.addLast(attributes.getValue("ref"));
...
//                System.out.println("Highway type: " + v);
      if (ALLOWED_HIGHWAY_TYPES.contains(v)) {
          possibleValidHighway = true;
      }
            } else if (k.equals("name")) {
                //System.out.println("WayName: " + v);
            }
...
//            System.out.println("Node's name: " + attributes.getValue("v"));
            g.addName(currentId, attributes.getValue("k"));
        }
    }
...
//            System.out.println("Finishing a way...");
            if (possibleValidHighway) {
                g.addEdge(possibleEdges);
                possibleValidHighway = false;
                possibleEdges = new LinkedList<>();
            } else {
                possibleEdges = new LinkedList<>();
            }
        }
